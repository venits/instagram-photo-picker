      ...
      <div className={css(styles.buttonsContainer)}>
        <div className={css(styles.cancelContainer)}>
          <button className={css(styles.cancel)} onClick={this.props.cancel}>
            <img className={css(styles.icon)} src="https://firebasestorage.googleapis.com/v0/b/instagram-photo-picker.appspot.com/o/cancel.svg?alt=media&token=ca5cc7e3-d1e8-411f-81e7-5b48c93d76d1" alt="CANCEL" />
          </button>
        </div>
        <div className={css(styles.loadContainer)}>
          <button className={css(styles.load)} onClick={this.props.load}>
            ...
            : <img className={css(styles.icon)} src="https://firebasestorage.googleapis.com/v0/b/instagram-photo-picker.appspot.com/o/more.svg?alt=media&token=834853a5-7efc-494e-8a4f-8d485136ada2" alt="LOAD MORE" />}
          </button>
        </div>
        <div className={css(styles.confirmContainer)}>
          ...
          >
            ...
            <img className={css(styles.icon)} src="https://firebasestorage.googleapis.com/v0/b/instagram-photo-picker.appspot.com/o/select.svg?alt=media&token=a4845fdc-1428-45b0-8d8d-b5a7c8ca0107" alt="SELECT" />
          </button>
        </div>
      </div>
    );
